...
//fun AjouterTransactionScreen(navController: NavController, viewModel: TransactionViewModel){
...
/*                                                    TransactionViewModel().insert(
                                                        Transaction(title = title, type = type, category = category, amount = amount, date = "")
                                                    )*/
                                                ...
                                                navController.navigate(GFScreens.TransactionScreen.name)
                                    })
